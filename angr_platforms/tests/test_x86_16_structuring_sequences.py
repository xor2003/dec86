...
def test_sequence_merge_is_unsafe_for_back_edge_successor() -> None:
...
def test_sequence_merge_is_safe_for_plain_linear_chain() -> None:
...
def test_sequence_merge_is_unsafe_when_successor_has_typed_ir_condition() -> None:
...
def test_sequence_merge_is_unsafe_for_guard_region_with_single_successor() -> None:
