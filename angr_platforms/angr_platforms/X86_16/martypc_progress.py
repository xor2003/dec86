...
MARTYPC_PRIORITY_SPECS: tuple[MartypcPrioritySpec, ...] = (
    ...
    MartypcPrioritySpec(
        ...
        completion_signal="The mixed-width matrix is explicit, but the 386 extension path still needs more coverage.",
    ),
    MartypcPrioritySpec(
        code="P1.3",
    ...
    MartypcPrioritySpec(
        ...
        completion_signal="The triage workflow exists, but the harness still needs tighter automation.",
    ),
    MartypcPrioritySpec(
        code="P2.3",
