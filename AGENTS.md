...
- This project is **not** aiming to become a transpiler. A separate transpiler exists elsewhere.
- The goal here is an **angr-based decompiler** for 16-bit x86 real-mode binaries that produces **human-readable C**.
